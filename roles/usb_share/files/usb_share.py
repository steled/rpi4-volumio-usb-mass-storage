...
#CMD_MOUNT = "mount -a; modprobe g_mass_storage file=/piusb.bin stall=0 ro=1"
# mount -a not working correctly
CMD_MOUNT = "mount -t ntfs /piusb.bin /mnt/usb_share; modprobe g_mass_storage file=/piusb.bin stall=0 ro=1"
